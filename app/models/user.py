...
class User(Base):
    ...
    projects_as_buyer = relationship(
        "Project", back_populates="buyer", foreign_keys="Project.buyer_id"
    )
    projects_as_seller = relationship(
        "Project", back_populates="seller", foreign_keys="Project.seller_id"
    )

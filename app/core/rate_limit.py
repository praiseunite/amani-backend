    ...
    def _refill_bucket(self, client_id: str, current_time: float) -> float:
        ...
        if bucket_data is None:
            ...
            self.redis_client.setex(
                bucket_key, 3600, f"{tokens},{current_time}"  # Expire after 1 hour of inactivity
            )
            return tokens
        ...
        self.redis_client.setex(bucket_key, 3600, f"{new_tokens},{current_time}")
    ...
    def get_stats(self, client_id: str) -> Dict[str, any]:
        ...
        try:
            ...
            last_minute_requests = sum(
                1 for t in history if current_time - float(t.decode("utf-8")) <= 60
            )

...
class TestFinCraClient:
    ...
    def test_client_initialization(self):
        ...
        client = FinCraClient(
            api_key="test_key", api_secret="test_secret", base_url="https://api.fincra.test"
        )
    ...
    def test_client_with_custom_retries(self):
        ...
        client = FinCraClient(
            api_key="test_key", api_secret="test_secret", max_retries=5, retry_delay=2.0
        )
    ...
    def test_fincra_error_creation(self):
        ...
        error = FinCraError(
            message="Payment failed", status_code=400, response_data={"error": "Invalid request"}
        )

...
class TestSequentialIDs:
    ...
    def test_wallet_registry_sequential_ids(self):
        ...
        wallet1 = WalletRegistry(
            user_id=user_id, provider=WalletProvider.FINCRA, provider_account_id="account1"
        )
        wallet2 = WalletRegistry(
            user_id=user_id, provider=WalletProvider.PAYSTACK, provider_account_id="account2"
        )
    ...
    def test_hold_sequential_ids(self):
        ...
        hold1 = Hold(user_id=user_id, amount=100.00, currency="USD", reference="ref1")
        hold2 = Hold(user_id=user_id, amount=200.00, currency="USD", reference="ref2")
